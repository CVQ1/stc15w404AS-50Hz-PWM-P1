...
unsigned char pwm[9]={100,100,100,100,100,100,100,100,100};	//50--250 从pwm[0]-pwm[7]对应P10-P17
unsigned int times=0;

void	GPIO_config(void)
{
	GPIO_InitTypeDef	GPIO_InitStructure;				//结构定义
	GPIO_InitStructure.Pin  = 0xff;	//指定要初始化的IO, GPIO_Pin_0 ~ GPIO_Pin_7, 或操作
...
void	Timer_config(void)
{
	...
	TIM_InitStructure.TIM_Value     = 65536UL - (MAIN_Fosc / 1176200UL);		//初值,试出来的
